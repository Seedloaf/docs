...
Once there, expose port 19132 and click "save port". Once that is saved, you should see some text saying
<code>"Port 19132 is exposed on nsXYZ.seedloaf.com:YOUR_PORT"</code>. To connect through Bedrock, use the newly exposed port and your .seedloaf.gg IP to connect!
