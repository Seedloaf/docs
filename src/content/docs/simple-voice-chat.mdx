...
from a mod site like CurseForge or Modrinth. Download the version that matches the mod loader you 
intend to use on Seedloaf.
...
Paste the Seedloaf port you copied so that the `voice_host` is set to the new port. It should look something 
